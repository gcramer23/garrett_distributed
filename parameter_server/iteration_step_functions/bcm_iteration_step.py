def bcm_iteration_step(self, ddp_model, criterion, optimizer, hook_state, epoch, index, batch):
    r"""
    A method that performs an iteration of training for the Bert Commonsense Model.
    Args:
    ...
    loss = criterion(ddp_model, batch)[0]
